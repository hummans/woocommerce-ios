...
private extension DeprecatedDashboardStatsViewController {
    struct Constants {
        ...
        static let details = NSLocalizedString("Make sure you are running the latest version of WooCommerce on your site and that you " +
                                               "haveWooCommerce Admin activated.",
